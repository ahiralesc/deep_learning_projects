...
| [The hidden message](hidden_msg/)|Generative|Given an encoded message, create a decoder capable of decoding the encoded message|AE (CNN Autoencoder)|
| [MNIST](mnist_cvae/|Generative|Given a class label generate clothing |CVAE (CNN Conditional Variationa Autoencoder)|
